public class Demo {
  public static void main(String [] args){
    ...
    car2.setColor("YELLOw");// car2 -> object reference, storing the object //*****/ the most important///*****
    car.setColor("BLUE");
    //car2 -> YELLOW
    //car - > BLUE
    System.out.println(car2);//print >>>Car@8bcc55f<<< = memory address or called reference address in the stack
