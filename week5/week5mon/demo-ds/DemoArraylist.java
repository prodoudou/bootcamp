...
public class DemoArraylist {
  public static void main(String[] args) {
    ...
    ArrayList<Integer> numbers2 = new ArrayList<>();// declare empty array
    ...
    // Define output array type for toArray() perform converison
    arr2 = numbers2.toArray(arr2);
    System.out.println(Arrays.toString(arr2));// [1, 3, 2, 4, null]

    // ArrayList<int>, not support primitive
    // Acecess elements IN ArrayLiST
    for (int i = 0; i < numbers2.size(); i++) {
      System.out.println(numbers2.get(i));// Possible to have Index outOfBound
    }
    ...
    numbers2.addAll(numbers3);// add all item from numbers3 to numbers2
    ...
    System.out.println(numbers3.size());// 4
    ...
    System.out.println(numbers2.lastIndexOf(1));
    ...
    System.out.println(numbers3);// false


    numbers2.add(1,4);//insert
    System.out.println(numbers2);//1, 4, 3, 4, null]
    numbers2.clear();// remve all element
