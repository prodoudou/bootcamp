...
public class DemoArrayList {
  public static void main(String[] args) {
    ...
    //Strean,forEAch
    streamStrings.forEach(s -> System.out.println("test= " +s));//abc //foreach(consumer's return type is void 所打唔係TYPE既野)
    ...
    strings2.stream()//
    .sorted((s1, s2) -> s2.compareTo(s1))// descebdubg order// natural order// this is stream type then nd to  change type
    .collect(Collectors.toList())
