package week6.weekthu.methodreference;
...
public class Demo {
  public static void main(String[] args) {
    ...
    Supplier<Integer> strLength2 = name::length;// ::= lambda

    List<String> words = Arrays.asList("apple", "banna", "orange");
    Comparator<String> compare = (s1, s2) -> s2.compareTo(s1);
    Comparator<String> compare2 = String::compareTo;//instance method

    Function<String, Integer> StringToInteger = str -> Integer.valueOf(str);
    Function<String, Integer> StringToInteger2 = Integer::valueOf; // consume String to integer?
    // 
